...
class CartManager
{
    ...
    public function changeQuantity(Products $product, int $quantity): void
    {
    ...
    public function removeFromCart(Products $product): void
    {
        $userCart = $this->getCart();
    ...
    public function getCartItem(Order $cart, Model|Products $product): ?OrderDetails
    {
